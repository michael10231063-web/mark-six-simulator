...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/api/latest-result') || url.pathname.endsWith('/latest-result.json') || url.pathname.endsWith('/draw-history.json') || url.pathname.endsWith('/api/draw-history')) return;
